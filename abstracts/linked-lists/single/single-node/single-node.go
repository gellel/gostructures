...
// AssignNext sets the argument Linked-List-Node as the accessed Linked-List-Node's adjacent Linked-List-Node;
// returns the argument Linked-List-Node if next is set to true.
...
// RemoveNext removes the accessed Linked-List-Node's adjacent Linked-List-Node;
// returns accessed Linked-List-Node.
